...
public:
	...
	void DrawSetTextureRGBA(int textureID, unsigned char const* colors, int w, int h)
	{
		...
		return call_vfunc<oDrawSetTextColor>(this, Offsets::VMT::Surface_DrawSetTextureRGBA)(
			this, textureID, colors, w, h);
	}
	...
	void DrawTexturedPolygon(int vtxCount, FontVertex_t* vtx, bool bClipVertices = true)
	{
		...
		return call_vfunc<oDrawSetTextColor>(this, Offsets::VMT::Surface_DrawTexturedPolygon)(
			this, vtxCount, vtx, bClipVertices);
	}
	...
	void SetFontGlyphSet(unsigned long font, const char* windowsFontName, int tall, int weight, int blur, int scanlines,
		int flags)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, unsigned long, const char*, int, int, int, int, int, int, int);
		call_vfunc<OriginalFn>(this, Offsets::VMT::Surface_SetFontGlyphSet)(
