...
public:
		...
		const char* pComplainPrefix = nullptr)
	{
		...
		return call_vfunc<oFindMaterial>(this, Offsets::VMT::MaterialSystem_FindMaterial)(
	...
	IMaterial* CreateMaterial(const char* pMaterialName, KeyValues* pVMTKeyValues)
	{
		...
		return call_vfunc<oCreateMaterial>(this, Offsets::VMT::MaterialSystem_CreateMaterial)(
			this, pMaterialName, pVMTKeyValues);
	}
};
